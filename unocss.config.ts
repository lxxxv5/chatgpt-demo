...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-retry-btn': 'fi gap-1 px-2 py-0.5 op-70 border border-slate rounded-md text-sm cursor-pointer hover:bg-slate/10 m-1',
    'gpt-delete-btn': 'fi gap-1 px-2 py-0.5 op-0 border border-slate rounded-md text-sm cursor-pointer hover:bg-slate/10 hidden',
